            ...
            <div className="px-6 py-5">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  {earnings.map((d) => (
                    <Row key={d.id} label={d.salaryComponent.name} amount={d.amount} rate={(d.amount / payslip.basicSalary) * 100} />
                  ))}
                  ...
                  <Row label="PF Employee" amount={-payslip.pfEmployee} isDeduction rate={(payslip.pfEmployee / payslip.basicSalary) * 100} />
                  <Row
                    label="PF Employer"
      ...
      >
        ...
        <div>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              ...
              {earnings.map((d) => (
                <PrintRow key={d.id} label={d.salaryComponent.name} amount={d.amount} rate={(d.amount / payslip.basicSalary) * 100} />
              ))}
        ...
        <div>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              <PrintRow label="PF Employee" amount={payslip.pfEmployee} deduction rate={(payslip.pfEmployee / payslip.basicSalary) * 100} />
              <PrintRow label="PF Employer" amount={payslip.pfEmployer} deduction rate={(payslip.pfEmployer / payslip.basicSalary) * 100} />
